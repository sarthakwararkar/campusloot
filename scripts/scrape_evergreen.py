...
def scrape():
    ...
    for deal in EVERGREEN_DEALS:
        result = upsert_deal(
            ...
            source=deal.get("source", "manual_evergreen"),
            is_verified=True,
            is_active=True,
        )
        if result:
            ...
            print(f"  ✗ Skipped (duplicate or error): {deal['title']}")

    print(f"\n✅ Evergreen scraper done: {count}/{len(EVERGREEN_DEALS)} deals upserted.")
    return count
